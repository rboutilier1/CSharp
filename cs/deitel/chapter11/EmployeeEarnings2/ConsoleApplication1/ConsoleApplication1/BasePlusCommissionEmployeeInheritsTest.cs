...
class BasePlusCommissionEmployeeInheritsTest
{
    public static void Main(string[] args)
    {
        try
        {
            BasePlusCommissionEmployeeInherits employee = new BasePlusCommissionEmployeeInherits("Bob", "Lewis", "333-33-3333", 5000.00M, .04M, 300.00M);
